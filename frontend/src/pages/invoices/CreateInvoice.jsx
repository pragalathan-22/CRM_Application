...
if (savedEstimate) {
  return (
<div
  className="estimate-print-container"
  style={{
    width: "210mm",
    minHeight: "297mm",
    padding: "20mm",
...
>
      ...
      <div
        id="printArea"
        className="p-6 text-sm text-gray-800 font-sans max-w-4xl mx-auto bg-white"
      >
        ...
        <div className="grid grid-cols-2 mb-4">
          <p>
            <strong>Estimate Date:</strong> {savedEstimate.estimateDate}
          </p>
          <p>
            <strong>Estimate No:</strong> {savedEstimate.estimateNumber}
          </p>
          <p>
            <strong>Reference No:</strong>{" "}
            {savedEstimate.referenceNumber || "-"}
          </p>
          <p>
            <strong>Due Date:</strong> {savedEstimate.dueDate}
          </p>
        </div>
          ...
          <tbody>
            ...
            <tr className="font-semibold">
              ...
              <td className="border p-1">
                {savedEstimate.totalCGST.toFixed(2)}
              </td>
              <td className="border p-1">
                {savedEstimate.totalSGST.toFixed(2)}
              </td>
              <td className="border p-1">
                {savedEstimate.totalTaxable.toFixed(2)}
              </td>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td className="text-right">
                  {(
                    savedEstimate.totalCGST + savedEstimate.totalSGST
                  ).toFixed(2)}
                </td>
              </tr>
              <tr>
